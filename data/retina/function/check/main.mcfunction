...
scoreboard players operation __math__.N retina.__variable__ = $step retina.__variable__
function retina:__private__/math_sqrt/main
scoreboard players operation $step_count retina.__variable__ = __math__.x_n retina.__variable__
