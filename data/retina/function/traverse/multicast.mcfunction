...
execute if score $horizontal_count retina.__variable__ matches ..0 run tellraw @a ["",{"text":"[Error] ","color":"dark_red","type":"text"},{"text":"HorizontalCount storage has invalid value of ","color":"red","type":"text"},{"score":{"name":"$horizontal_count","objective":"retina.__variable__"},"color":"red","type":"score"}]
execute if score $horizontal_count retina.__variable__ matches ..0 run return 0
execute if score $vertical_count retina.__variable__ matches ..0 run tellraw @a ["",{"text":"[Error] ","color":"dark_red","type":"text"},{"text":"VerticalCount storage has invalid value of ","color":"red","type":"text"},{"score":{"name":"$vertical_count","objective":"retina.__variable__"},"color":"red","type":"score"}]
execute if score $vertical_count retina.__variable__ matches ..0 run return 0
execute if score $centered_count retina.__variable__ matches ..-1 run tellraw @a ["",{"text":"[Error] ","color":"dark_red","type":"text"},{"text":"CenteredCount storage has invalid value of ","color":"red","type":"text"},{"score":{"name":"$centered_count","objective":"retina.__variable__"},"color":"red","type":"score"}]
