...
execute as @e[type=!#retina:ignore,tag=retina.possible_target] if score @s retina.id = $closest_cuboid_id retina.__variable__ run function retina:__private__/anonymous/12
...
execute if score $expand_entity_hitboxes retina.__variable__ = $expand_entity_hitboxes retina.__variable__ run function retina:__private__/if_else/29
scoreboard players operation $targeted_X retina.__variable__ += $origin_X retina.__variable__
execute store result storage retina:output ContactCoordinates[0] double 0.0020833 run scoreboard players get $targeted_X retina.__variable__
execute if score $nearest_axis retina.__variable__ matches 0 run function retina:__private__/if_else/30
scoreboard players operation $targeted_Y retina.__variable__ += $origin_Y retina.__variable__
execute store result storage retina:output ContactCoordinates[1] double 0.0020833 run scoreboard players get $targeted_Y retina.__variable__
execute if score $nearest_axis retina.__variable__ matches 1 run function retina:__private__/if_else/31
scoreboard players operation $targeted_Z retina.__variable__ += $origin_Z retina.__variable__
execute store result storage retina:output ContactCoordinates[2] double 0.0020833 run scoreboard players get $targeted_Z retina.__variable__
execute if score $nearest_axis retina.__variable__ matches 2 run function retina:__private__/if_else/32
...
execute store result storage retina:output Distance double 0.0020833 run scoreboard players get $total_distance retina.__variable__
execute if data storage retina:input {EndpointEntity:true} summon minecraft:marker run function retina:__private__/anonymous/13