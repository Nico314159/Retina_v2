...
scoreboard players set $k __variable__ 1024
scoreboard players operation $k __variable__ *= $step_X __variable__
...
scoreboard players set $k __variable__ 1024
scoreboard players operation $k __variable__ *= $step_Y __variable__
...
scoreboard players set $k __variable__ 1024
scoreboard players operation $k __variable__ *= $step_Z __variable__
