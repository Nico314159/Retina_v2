...
data modify storage retina:data Surfaces.West append value [[0,390,0,0,390,480]]
data modify storage retina:data Surfaces.East append value [[480,390,0,480,390,480]]
