...
execute if score $X_intersection retina.__variable__ >= $X0 retina.__variable__ if score $X_intersection retina.__variable__ <= $X1 retina.__variable__ if score $Z_intersection retina.__variable__ >= $Z0 retina.__variable__ if score $Z_intersection retina.__variable__ <= $Z1 retina.__variable__ run data modify storage retina:output HitFace set value "Bottom"