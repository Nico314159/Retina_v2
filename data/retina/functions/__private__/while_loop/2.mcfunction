...
execute if score $debug_messages retina.__variable__ matches 1.. run tellraw @a ["",{"text":"[BOTTOM] ","italic":true,"bold":true},{"text":"Relative Y: ","bold":false},{"italic":false,"color":"light_purple","score":{"name":"$relative_Y","objective":"retina.__variable__"}},{"text":", ","italic":false,"color":"light_purple"},{"text":"Y0: ","color":"white"},{"color":"light_purple","score":{"name":"$Y0","objective":"retina.__variable__"}}]
