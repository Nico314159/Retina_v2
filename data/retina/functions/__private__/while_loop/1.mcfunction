...
execute if score $debug_messages retina.__variable__ matches 1.. run tellraw @a ["",{"text":"[EAST] ","italic":true,"bold":true},{"text":"Relative X: ","bold":false},{"italic":false,"color":"light_purple","score":{"name":"$relative_X","objective":"retina.__variable__"}},{"text":", ","italic":false,"color":"light_purple"},{"text":"X0: ","color":"white"},{"color":"light_purple","score":{"name":"$X0","objective":"retina.__variable__"}}]
execute if score $relative_X retina.__variable__ >= $X0 retina.__variable__ run function retina:__private__/if_else/2
