...
execute if score $frac_Z __variable__ = $z0 __variable__ if score $frac_X __variable__ >= $x0 __variable__ if score $frac_X __variable__ <= $x1 __variable__ if score $frac_Y __variable__ >= $y0 __variable__ if score $frac_Y __variable__ <= $y1 __variable__ run function retina:find_closest_surface/ray_already_in_surface
execute if score $frac_Z __variable__ < $z0 __variable__ run function retina:__private__/if_else/10
