...
execute if score $debug_messages retina.__variable__ matches 1.. run tellraw @a ["",{"text":"[NORTH] ","italic":true,"bold":true},{"text":"Relative Z: ","bold":false},{"italic":false,"color":"light_purple","score":{"name":"$relative_Z","objective":"retina.__variable__"}},{"text":", ","italic":false,"color":"light_purple"},{"text":"Z0: ","color":"white"},{"color":"light_purple","score":{"name":"$Z0","objective":"retina.__variable__"}}]
execute if score $relative_Z retina.__variable__ <= $Z0 retina.__variable__ run function retina:__private__/if_else/5
