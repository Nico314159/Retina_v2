execute if block ~ ~ ~ minecraft:big_dripleaf[facing=north] run data modify storage retina:data Surfaces set value {Top:[[150,390,270,330,390,450]],Bottom:[[150,0,270,330,0,450]],West:[[150,0,270,150,390,450]],East:[[330,0,270,330,390,450]],North:[[150,0,270,330,390,270]],South:[[150,0,450,330,390,450]]}
execute if block ~ ~ ~ minecraft:big_dripleaf[facing=south] run data modify storage retina:data Surfaces set value {Top:[[150,390,30,330,390,210]],Bottom:[[150,0,30,330,0,210]],West:[[150,0,30,150,390,210]],East:[[330,0,30,330,390,210]],North:[[150,0,30,330,390,30]],South:[[150,0,210,330,390,210]]}
...
return run execute if block ~ ~ ~ minecraft:big_dripleaf[tilt=full]
return run execute if block ~ ~ ~ minecraft:big_dripleaf[tilt=partial] run function retina:__private__/if_else/9
