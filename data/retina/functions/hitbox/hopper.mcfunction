...
execute if block ~ ~ ~ minecraft:hopper[facing=north] run function retina:__private__/if_else/12
execute if block ~ ~ ~ minecraft:hopper[facing=down] run function retina:__private__/if_else/13