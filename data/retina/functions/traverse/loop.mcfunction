...
execute if score $nearest_axis __variable__ matches 0 if score $step __variable__ matches ..299 if score $end __variable__ matches 0 run function retina:traverse/x
execute if score $nearest_axis __variable__ matches 1 if score $step __variable__ matches ..299 if score $end __variable__ matches 0 run function retina:traverse/y
execute if score $nearest_axis __variable__ matches 2 if score $step __variable__ matches ..299 if score $end __variable__ matches 0 run function retina:traverse/z