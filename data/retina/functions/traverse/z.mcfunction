...
scoreboard players operation $DZ __variable__ = $Z __variable__
scoreboard players operation $DZ __variable__ %= 1000 __int__
scoreboard players operation $DZ __variable__ *= -1 __int__
execute if score $sign_Z __variable__ matches 1 run scoreboard players add $DZ __variable__ 1000
execute if score $sign_Z __variable__ matches -1 if score $DZ __variable__ matches 0 run scoreboard players set $DZ __variable__ -1000
scoreboard players operation $DX __variable__ = $DZ __variable__
scoreboard players operation $DX __variable__ *= $delta_Z __variable__
scoreboard players operation $DX __variable__ *= $sign_Z __variable__
...
scoreboard players operation $DY __variable__ = $DZ __variable__
scoreboard players operation $DY __variable__ *= $delta_Z __variable__
scoreboard players operation $DY __variable__ *= $sign_Z __variable__
...
scoreboard players operation $DZ __variable__ = $DZ __variable__
