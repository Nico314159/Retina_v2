...
execute if score $debug_messages __variable__ matches 1.. run tellraw @a ["",{"text":"Closest direction: ","bold":false,"color":"white"},{"text":"Z","bold":true,"color":"aqua"}]
scoreboard players operation $distance_Z __variable__ += $delta_Z __variable__
scoreboard players operation $step_Z __variable__ += $sign_Z __variable__
scoreboard players operation $int_Z __variable__ += $sign_Z __variable__
...
scoreboard players operation $relative_X __variable__ /= 1024 __int__
...
scoreboard players operation $relative_Y __variable__ /= 1024 __int__
...
scoreboard players operation $relative_Z __variable__ /= 1024 __int__
