...
scoreboard players operation $X __variable__ /= 1000 __int__
...
scoreboard players operation $Y __variable__ /= 1000 __int__
...
scoreboard players operation $Z __variable__ /= 1000 __int__
