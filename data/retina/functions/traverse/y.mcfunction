...
scoreboard players operation $relative_X retina.__variable__ /= 192 retina.__int__
...
scoreboard players operation $relative_Y retina.__variable__ /= 192 retina.__int__
...
scoreboard players operation $relative_Z retina.__variable__ /= 192 retina.__int__
