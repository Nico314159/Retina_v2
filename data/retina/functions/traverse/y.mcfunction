...
scoreboard players operation $DY __variable__ = $Y __variable__
scoreboard players operation $DY __variable__ %= 1000 __int__
scoreboard players operation $DY __variable__ *= -1 __int__
execute if score $sign_Y __variable__ matches 1 run scoreboard players add $DY __variable__ 1000
execute if score $sign_Y __variable__ matches -1 if score $DY __variable__ matches 0 run scoreboard players set $DY __variable__ -1000
scoreboard players operation $DX __variable__ = $DY __variable__
scoreboard players operation $DX __variable__ *= $delta_Y __variable__
scoreboard players operation $DX __variable__ *= $sign_Y __variable__
...
scoreboard players operation $DY __variable__ = $DY __variable__
...
scoreboard players operation $DZ __variable__ = $DY __variable__
scoreboard players operation $DZ __variable__ *= $delta_Y __variable__
scoreboard players operation $DZ __variable__ *= $sign_Y __variable__
