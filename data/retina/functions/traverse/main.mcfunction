execute if score $motion_x __variable__ > $motion_limit_x __variable__ run scoreboard players set $distance_x __variable__ 2147483647
execute if score $motion_y __variable__ > $motion_limit_y __variable__ run scoreboard players set $distance_y __variable__ 2147483647
execute if score $motion_z __variable__ > $motion_limit_z __variable__ run scoreboard players set $distance_z __variable__ 2147483647
...
execute if score $motion_end __variable__ matches 0 run function retina:traverse/main