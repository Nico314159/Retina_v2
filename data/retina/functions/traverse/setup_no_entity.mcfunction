...
execute store result score $ignore_blocks retina.__variable__ run data get storage retina:input IgnoreBlocks
data remove storage retina:input IgnoreBlocks
...
execute summon minecraft:marker run function retina:__private__/anonymous/1
