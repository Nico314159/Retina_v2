...
scoreboard players operation $relative_X __variable__ /= 1000 __int__
...
scoreboard players operation $scaled_int_X __variable__ = $relative_X __variable__
scoreboard players operation $scaled_int_X __variable__ /= 1000 __int__
scoreboard players operation $scaled_int_X __variable__ *= 1000 __int__
...
scoreboard players operation $relative_Y __variable__ /= 1000 __int__
...
scoreboard players operation $scaled_int_Y __variable__ = $relative_Y __variable__
scoreboard players operation $scaled_int_Y __variable__ /= 1000 __int__
scoreboard players operation $scaled_int_Y __variable__ *= 1000 __int__
...
scoreboard players operation $relative_Z __variable__ /= 1000 __int__
...
scoreboard players operation $scaled_int_Z __variable__ = $relative_Z __variable__
scoreboard players operation $scaled_int_Z __variable__ /= 1000 __int__
scoreboard players operation $scaled_int_Z __variable__ *= 1000 __int__
scoreboard players operation $distance_X __variable__ += $delta_X __variable__
