...
execute store result score $X __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[0] 1024
execute store result score $Y __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[1] 1024
execute store result score $Z __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[2] 1024
...
scoreboard players operation $frac_origin_X __variable__ %= 1024 __int__
...
scoreboard players set $delta_X __variable__ 1048576
...
scoreboard players operation $distance_X __variable__ %= 1024 __int__
...
scoreboard players operation $int_X __variable__ /= 1024 __int__
scoreboard players operation $frac_X __variable__ = $X __variable__
scoreboard players operation $frac_X __variable__ %= 1024 __int__
...
scoreboard players operation $frac_origin_Y __variable__ %= 1024 __int__
...
scoreboard players set $delta_Y __variable__ 1048576
...
scoreboard players operation $distance_Y __variable__ %= 1024 __int__
...
scoreboard players operation $int_Y __variable__ /= 1024 __int__
scoreboard players operation $frac_Y __variable__ = $Y __variable__
scoreboard players operation $frac_Y __variable__ %= 1024 __int__
...
scoreboard players operation $frac_origin_Z __variable__ %= 1024 __int__
...
scoreboard players set $delta_Z __variable__ 1048576
...
scoreboard players operation $distance_Z __variable__ %= 1024 __int__
...
scoreboard players operation $int_Z __variable__ /= 1024 __int__
scoreboard players operation $frac_Z __variable__ = $Z __variable__
scoreboard players operation $frac_Z __variable__ %= 1024 __int__
