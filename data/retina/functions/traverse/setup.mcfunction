...
execute store result score $X retina.__variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[0] 192
execute store result score $Y retina.__variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[1] 192
execute store result score $Z retina.__variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[2] 192
...
scoreboard players operation $frac_origin_X retina.__variable__ %= 192 retina.__int__
...
scoreboard players set $delta_X retina.__variable__ 36864
...
scoreboard players operation $distance_X retina.__variable__ %= 192 retina.__int__
...
scoreboard players operation $int_X retina.__variable__ /= 192 retina.__int__
scoreboard players operation $frac_X retina.__variable__ = $X retina.__variable__
scoreboard players operation $frac_X retina.__variable__ %= 192 retina.__int__
...
scoreboard players operation $frac_origin_Y retina.__variable__ %= 192 retina.__int__
...
scoreboard players set $delta_Y retina.__variable__ 36864
...
scoreboard players operation $distance_Y retina.__variable__ %= 192 retina.__int__
...
scoreboard players operation $int_Y retina.__variable__ /= 192 retina.__int__
scoreboard players operation $frac_Y retina.__variable__ = $Y retina.__variable__
scoreboard players operation $frac_Y retina.__variable__ %= 192 retina.__int__
...
scoreboard players operation $frac_origin_Z retina.__variable__ %= 192 retina.__int__
...
scoreboard players set $delta_Z retina.__variable__ 36864
...
scoreboard players operation $distance_Z retina.__variable__ %= 192 retina.__int__
...
scoreboard players operation $int_Z retina.__variable__ /= 192 retina.__int__
scoreboard players operation $frac_Z retina.__variable__ = $Z retina.__variable__
scoreboard players operation $frac_Z retina.__variable__ %= 192 retina.__int__
...
execute store result score $offset_Y retina.__variable__ run data get entity @s Pos[1] -192
scoreboard players operation $offset_Y retina.__variable__ += $Y retina.__variable__
execute if score $offset_Y retina.__variable__ matches 310..312 positioned ~ ~1.62 ~ run function retina:traverse/loop
execute if score $offset_Y retina.__variable__ matches 242..244 positioned ~ ~1.27 ~ run function retina:traverse/loop
execute if score $offset_Y retina.__variable__ matches 75..77 positioned ~ ~0.4 ~ run function retina:traverse/loop