...
execute if score $debug_messages __variable__ matches 1.. run tellraw @a ["",{"text":"Pitch: ","bold":false,"color":"white"},{"score":{"name":"$input_pitch","objective":"__variable__"},"color":"red"},{"text":", ","color":"red"},{"text":"Yaw: ","bold":false,"color":"white"},{"score":{"name":"$input_yaw","objective":"__variable__"},"color":"red"}]
function retina:math/gimbal_to_vec
execute if score $debug_messages __variable__ matches 1.. run tellraw @a ["",{"text":"Facing Vector: "},{"text":"[","color":"gold"},{"score":{"name":"$output_vec3.X","objective":"__variable__"},"color":"gold"},{"text":", ","color":"gold"},{"score":{"name":"$output_vec3.Y","objective":"__variable__"},"color":"gold"},{"text":", ","color":"gold"},{"score":{"name":"$output_vec3.Z","objective":"__variable__"},"color":"gold"},{"text":"]","color":"gold"}]
execute anchored eyes run summon minecraft:marker ^ ^ ^ {Tags:["retina.height"]}
execute store result score $X __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[0] 192
execute store result score $Y __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[1] 192
execute store result score $Z __variable__ run data get entity @e[type=marker,tag=retina.height,limit=1] Pos[2] 192
...
scoreboard players operation $frac_origin_X __variable__ %= 192 __int__
...
scoreboard players set $delta_X __variable__ 36864
...
scoreboard players operation $distance_X __variable__ %= 192 __int__
...
scoreboard players operation $int_X __variable__ /= 192 __int__
...
scoreboard players operation $frac_origin_Y __variable__ %= 192 __int__
...
scoreboard players set $delta_Y __variable__ 36864
...
scoreboard players operation $distance_Y __variable__ %= 192 __int__
...
scoreboard players operation $int_Y __variable__ /= 192 __int__
...
scoreboard players operation $frac_origin_Z __variable__ %= 192 __int__
...
scoreboard players set $delta_Z __variable__ 36864
...
scoreboard players operation $distance_Z __variable__ %= 192 __int__
...
scoreboard players operation $int_Z __variable__ /= 192 __int__
...
execute if score $debug_messages __variable__ matches 1.. run tellraw @a ["",{"text":"Origin: "},{"text":"[","color":"yellow"},{"score":{"name":"$int_X","objective":"__variable__"},"color":"yellow"},{"text":", ","color":"yellow"},{"score":{"name":"$int_Y","objective":"__variable__"},"color":"yellow"},{"text":", ","color":"yellow"},{"score":{"name":"$int_Z","objective":"__variable__"},"color":"yellow"},{"text":"]","color":"yellow"}]
scoreboard players set $step __variable__ 0
scoreboard players set $end __variable__ 0
execute store result score $offset_Y __variable__ run data get entity @s Pos[1] -192
scoreboard players operation $offset_Y __variable__ += $Y __variable__
execute if score $offset_Y __variable__ matches 310..312 positioned ~ ~1.62 ~ run function retina:traverse/loop
execute if score $offset_Y __variable__ matches 242..244 positioned ~ ~1.27 ~ run function retina:traverse/loop
execute if score $offset_Y __variable__ matches 75..77 positioned ~ ~0.4 ~ run function retina:traverse/loop